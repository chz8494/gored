...
func (e *Latoken) GetTradingWebURL(pair *pair.Pair) string {
	return fmt.Sprintf("https://latoken.com/exchange/%v-%v", e.GetSymbolByCoin(pair.Base), e.GetSymbolByCoin(pair.Target))
}
