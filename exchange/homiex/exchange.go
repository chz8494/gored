...
func (e *Homiex) GetTradingWebURL(pair *pair.Pair) string { // ETH/BTC
	return fmt.Sprintf("https://www.homiex.com/exchange/654/%s/%s", e.GetSymbolByCoin(pair.Target), e.GetSymbolByCoin(pair.Base))
}
