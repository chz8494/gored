...
func (e *Digifinex) GetTradingWebURL(pair *pair.Pair) string {
	return fmt.Sprintf("https://www.digifinex.com/en-ww/trade/%v/%v", strings.ToUpper(e.GetSymbolByCoin(pair.Base)), strings.ToUpper(e.GetSymbolByCoin(pair.Target)))
}
